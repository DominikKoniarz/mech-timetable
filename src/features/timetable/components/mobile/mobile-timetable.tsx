...
import MobileTableHead from "@/features/timetable/components/mobile/mobile-table-head";
import MobileTableBody from "@/features/timetable/components/mobile/mobile-table-body";
